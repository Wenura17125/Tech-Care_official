        ...
        (e.exports = function (e, t) {
          ...
          function w(n, r) {
            ...
            g ||
              ...
              (g.outside =
                ((i = g).outside && d.off("click" + E, i.outside),
                function (t) {
                  var n = e(t.target);
            ...
            m &&
              ...
              u
                ...
                : ((s = g).overlay ||
                    ...
                    U(s, !0)),
                  g.button.on("click" + E, F(g)),
                  g.menu.on("click" + E, "a", L(g)),
                  g.button.on(
                    "keydown" + E,
                    ((l = g),
                    function (e) {
                      switch (e.keyCode) {
                        ...
                        case o.ENTER:
                          return (
                            F(l)(), e.preventDefault(), e.stopPropagation()
                          );
                        case o.ESCAPE:
                          return U(l), e.preventDefault(), e.stopPropagation();
                        case o.ARROW_RIGHT:
                        case o.ARROW_DOWN:
                        case o.HOME:
                        case o.END:
          ...
          function R(e) {
            ...
            (n.animOver = /^over/.test(i)),
              ...
              r.animation !== i && e.open && t.defer(S, e),
            ...
            s.preview =
              function () {
                (u = h && r.env("design")),
                  (c = r.env("editor")),
                  (n = e(document.body)),
                  (a = d.find(E)).length && (a.each(w), T(), r.resize.on(O));
              }),
            (s.destroy = function () {
              (b = e()), T(), a && a.length && a.each(A);
            });
